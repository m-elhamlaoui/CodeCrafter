...
public class SpringGenParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SpringGenGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDockerInstructionAccess().getAlternatives(), "rule__DockerInstruction__Alternatives");
			...
			builder.put(grammarAccess.getBaseImageAccess().getGroup(), "rule__BaseImage__Group__0");
			builder.put(grammarAccess.getRunInstructionAccess().getGroup(), "rule__RunInstruction__Group__0");
			builder.put(grammarAccess.getCopyInstructionAccess().getGroup(), "rule__CopyInstruction__Group__0");
			builder.put(grammarAccess.getExposeInstructionAccess().getGroup(), "rule__ExposeInstruction__Group__0");
			builder.put(grammarAccess.getEnvInstructionAccess().getGroup(), "rule__EnvInstruction__Group__0");
			builder.put(grammarAccess.getWorkdirInstructionAccess().getGroup(), "rule__WorkdirInstruction__Group__0");
			builder.put(grammarAccess.getCmdInstructionAccess().getGroup(), "rule__CmdInstruction__Group__0");
			builder.put(grammarAccess.getAngularAppAccess().getGroup(), "rule__AngularApp__Group__0");
			builder.put(grammarAccess.getAngularComponentAccess().getGroup(), "rule__AngularComponent__Group__0");
			builder.put(grammarAccess.getAngularServiceAccess().getGroup(), "rule__AngularService__Group__0");
			builder.put(grammarAccess.getAngularServiceMethodAccess().getGroup(), "rule__AngularServiceMethod__Group__0");
			builder.put(grammarAccess.getAngularModuleAccess().getGroup(), "rule__AngularModule__Group__0");
			builder.put(grammarAccess.getAngularModuleImportAccess().getGroup(), "rule__AngularModuleImport__Group__0");
			...
			builder.put(grammarAccess.getSpringBootProjectAccess().getDockerfileAssignment_4(), "rule__SpringBootProject__DockerfileAssignment_4");
			builder.put(grammarAccess.getSpringBootProjectAccess().getAngularAppAssignment_5(), "rule__SpringBootProject__AngularAppAssignment_5");
			...
			builder.put(grammarAccess.getDockerfileAccess().getBaseImageAssignment_2(), "rule__Dockerfile__BaseImageAssignment_2");
			builder.put(grammarAccess.getDockerfileAccess().getInstructionsAssignment_3(), "rule__Dockerfile__InstructionsAssignment_3");
			builder.put(grammarAccess.getBaseImageAccess().getImageAssignment_1(), "rule__BaseImage__ImageAssignment_1");
			builder.put(grammarAccess.getRunInstructionAccess().getCommandAssignment_1(), "rule__RunInstruction__CommandAssignment_1");
			builder.put(grammarAccess.getCopyInstructionAccess().getSourceAssignment_1(), "rule__CopyInstruction__SourceAssignment_1");
			builder.put(grammarAccess.getCopyInstructionAccess().getTargetAssignment_3(), "rule__CopyInstruction__TargetAssignment_3");
			builder.put(grammarAccess.getExposeInstructionAccess().getPortAssignment_1(), "rule__ExposeInstruction__PortAssignment_1");
			builder.put(grammarAccess.getEnvInstructionAccess().getKeyAssignment_1(), "rule__EnvInstruction__KeyAssignment_1");
			builder.put(grammarAccess.getEnvInstructionAccess().getValueAssignment_2(), "rule__EnvInstruction__ValueAssignment_2");
			builder.put(grammarAccess.getWorkdirInstructionAccess().getPathAssignment_1(), "rule__WorkdirInstruction__PathAssignment_1");
			builder.put(grammarAccess.getCmdInstructionAccess().getCommandAssignment_1(), "rule__CmdInstruction__CommandAssignment_1");
			builder.put(grammarAccess.getAngularAppAccess().getNameAssignment_2(), "rule__AngularApp__NameAssignment_2");
			builder.put(grammarAccess.getAngularAppAccess().getComponentsAssignment_3(), "rule__AngularApp__ComponentsAssignment_3");
			builder.put(grammarAccess.getAngularAppAccess().getServicesAssignment_4(), "rule__AngularApp__ServicesAssignment_4");
			builder.put(grammarAccess.getAngularAppAccess().getModulesAssignment_5(), "rule__AngularApp__ModulesAssignment_5");
			builder.put(grammarAccess.getAngularComponentAccess().getNameAssignment_1(), "rule__AngularComponent__NameAssignment_1");
			builder.put(grammarAccess.getAngularComponentAccess().getSelectorAssignment_3(), "rule__AngularComponent__SelectorAssignment_3");
			builder.put(grammarAccess.getAngularComponentAccess().getTemplateUrlAssignment_4(), "rule__AngularComponent__TemplateUrlAssignment_4");
			builder.put(grammarAccess.getAngularComponentAccess().getStyleUrlsAssignment_5(), "rule__AngularComponent__StyleUrlsAssignment_5");
			builder.put(grammarAccess.getAngularServiceAccess().getNameAssignment_1(), "rule__AngularService__NameAssignment_1");
			builder.put(grammarAccess.getAngularServiceAccess().getMethodsAssignment_3(), "rule__AngularService__MethodsAssignment_3");
			builder.put(grammarAccess.getAngularServiceMethodAccess().getNameAssignment_1(), "rule__AngularServiceMethod__NameAssignment_1");
			builder.put(grammarAccess.getAngularServiceMethodAccess().getReturnTypeAssignment_4(), "rule__AngularServiceMethod__ReturnTypeAssignment_4");
			builder.put(grammarAccess.getAngularServiceMethodAccess().getParametersAssignment_5(), "rule__AngularServiceMethod__ParametersAssignment_5");
			builder.put(grammarAccess.getAngularModuleAccess().getNameAssignment_1(), "rule__AngularModule__NameAssignment_1");
			builder.put(grammarAccess.getAngularModuleAccess().getDeclarationsAssignment_3(), "rule__AngularModule__DeclarationsAssignment_3");
			builder.put(grammarAccess.getAngularModuleAccess().getImportsAssignment_4(), "rule__AngularModule__ImportsAssignment_4");
			builder.put(grammarAccess.getAngularModuleAccess().getProvidersAssignment_5(), "rule__AngularModule__ProvidersAssignment_5");
			builder.put(grammarAccess.getAngularModuleImportAccess().getModuleAssignment_1(), "rule__AngularModuleImport__ModuleAssignment_1");
		}
	}
