 ...
 * </p>
 * <ul>
 *   <li>{@link dockermetamodel.impl.ExposeImpl#getArgument <em>Argument</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExposeImpl extends InstructionImpl implements Expose {
	...
	protected EClass eStaticClass() {
		return DockerfileGeneratorPackage.Literals.EXPOSE;
	}
	...
	public EList<Argument> getArgument() {
		if (argument == null) {
			argument = new EObjectContainmentEList<Argument>(Argument.class, this,
					DockerfileGeneratorPackage.EXPOSE__ARGUMENT);
		}
		return argument;
	}
