 ...
 * </p>
 * <ul>
 *   <li>{@link dockermetamodel.impl.FromImpl#getArgument <em>Argument</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FromImpl extends InstructionImpl implements From {
	...
	protected EClass eStaticClass() {
		return DockerfileGeneratorPackage.Literals.FROM;
	}
	...
	public NotificationChain basicSetArgument(Argument newArgument, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DockerfileGeneratorPackage.FROM__ARGUMENT, oldArgument, newArgument);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newArgument != argument) {
			...
			if (argument != null)
				msgs = ((InternalEObject) argument).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DockerfileGeneratorPackage.FROM__ARGUMENT, null, msgs);
			if (newArgument != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DockerfileGeneratorPackage.FROM__ARGUMENT,
