 ...
 * @generated
 */
public class DockerfileGeneratorPackageImpl extends EPackageImpl implements DockerfileGeneratorPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see dockermetamodel.DockerfileGeneratorPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private DockerfileGeneratorPackageImpl() {
		super(eNS_URI, DockerfileGeneratorFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link DockerfileGeneratorPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static DockerfileGeneratorPackage init() {
		if (isInited)
			return (DockerfileGeneratorPackage) EPackage.Registry.INSTANCE
					.getEPackage(DockerfileGeneratorPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredDockerfileGeneratorPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		DockerfileGeneratorPackageImpl theDockerfileGeneratorPackage = registeredDockerfileGeneratorPackage instanceof DockerfileGeneratorPackageImpl
				? (DockerfileGeneratorPackageImpl) registeredDockerfileGeneratorPackage
				: new DockerfileGeneratorPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theDockerfileGeneratorPackage.createPackageContents();

		// Initialize created meta-data
		theDockerfileGeneratorPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theDockerfileGeneratorPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(DockerfileGeneratorPackage.eNS_URI, theDockerfileGeneratorPackage);
		return theDockerfileGeneratorPackage;
	}
	 ...
	 * @generated
	 */
	public DockerfileGeneratorFactory getDockerfileGeneratorFactory() {
		return (DockerfileGeneratorFactory) getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getOption_Value(), ecorePackage.getEString(), "value", null, 0, 1, Option.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(instructionEClass, Instruction.class, "Instruction", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getInstruction_Option(), this.getOption(), null, "option", null, 0, -1, Instruction.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInstruction_Comment(), this.getComment(), null, "comment", null, 0, -1, Instruction.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFrom_Argument(), this.getArgument(), null, "argument", null, 1, 1, From.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(dockerfileEClass, Dockerfile.class, "Dockerfile", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDockerfile_Instruction(), this.getInstruction(), null, "instruction", null, 1, -1,
				Dockerfile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDockerfile_Name(), ecorePackage.getEString(), "name", null, 0, 1, Dockerfile.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDockerfile_Version(), ecorePackage.getEString(), "version", null, 0, 1, Dockerfile.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCopy_Argument(), this.getArgument(), null, "argument", null, 1, -1, Copy.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(runEClass, Run.class, "Run", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRun_Argument(), this.getArgument(), null, "argument", null, 1, -1, Run.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(workdirEClass, Workdir.class, "Workdir", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getWorkdir_Argument(), this.getArgument(), null, "argument", null, 1, 1, Workdir.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(cmdEClass, Cmd.class, "Cmd", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCmd_Argument(), this.getArgument(), null, "argument", null, 1, -1, Cmd.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(exposeEClass, Expose.class, "Expose", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getExpose_Argument(), this.getArgument(), null, "argument", null, 1, -1, Expose.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
...
} //DockerfileGeneratorPackageImpl
