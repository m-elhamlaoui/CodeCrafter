 ...
 * </p>
 * <ul>
 *   <li>{@link dockermetamodel.impl.CopyImpl#getArgument <em>Argument</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CopyImpl extends InstructionImpl implements Copy {
	...
	protected EClass eStaticClass() {
		return DockerfileGeneratorPackage.Literals.COPY;
	}
	...
	public EList<Argument> getArgument() {
		if (argument == null) {
			argument = new EObjectContainmentEList<Argument>(Argument.class, this,
					DockerfileGeneratorPackage.COPY__ARGUMENT);
		}
		return argument;
	}
