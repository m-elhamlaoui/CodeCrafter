...
public class InstructionImpl extends MinimalEObjectImpl.Container implements Instruction {
	...
	protected EClass eStaticClass() {
		return DockerfileGeneratorPackage.Literals.INSTRUCTION;
	}
	...
	public EList<Option> getOption() {
		if (option == null) {
			option = new EObjectContainmentEList<Option>(Option.class, this,
					DockerfileGeneratorPackage.INSTRUCTION__OPTION);
		}
		return option;
	}
	...
	public EList<Comment> getComment() {
		if (comment == null) {
			comment = new EObjectContainmentEList<Comment>(Comment.class, this,
					DockerfileGeneratorPackage.INSTRUCTION__COMMENT);
		}
		return comment;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DockerfileGeneratorPackage.INSTRUCTION__NAME, oldName,
					name));
	}
