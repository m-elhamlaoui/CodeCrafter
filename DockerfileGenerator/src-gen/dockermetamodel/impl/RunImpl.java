 ...
 * </p>
 * <ul>
 *   <li>{@link dockermetamodel.impl.RunImpl#getArgument <em>Argument</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RunImpl extends InstructionImpl implements Run {
	/**
	...
	protected EClass eStaticClass() {
		return DockerfileGeneratorPackage.Literals.RUN;
	}
	...
	public EList<Argument> getArgument() {
		if (argument == null) {
			argument = new EObjectContainmentEList<Argument>(Argument.class, this,
					DockerfileGeneratorPackage.RUN__ARGUMENT);
		}
		return argument;
	}
