 ...
 * </p>
 * <ul>
 *   <li>{@link dockermetamodel.impl.CmdImpl#getArgument <em>Argument</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CmdImpl extends InstructionImpl implements Cmd {
	...
	protected EClass eStaticClass() {
		return DockerfileGeneratorPackage.Literals.CMD;
	}
	...
	public EList<Argument> getArgument() {
		if (argument == null) {
			argument = new EObjectContainmentEList<Argument>(Argument.class, this,
					DockerfileGeneratorPackage.CMD__ARGUMENT);
		}
		return argument;
	}
