 ...
 * </p>
 * <ul>
 *   <li>{@link dockermetamodel.impl.WorkdirImpl#getArgument <em>Argument</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkdirImpl extends InstructionImpl implements Workdir {
	...
	protected EClass eStaticClass() {
		return DockerfileGeneratorPackage.Literals.WORKDIR;
	}
	...
	public NotificationChain basicSetArgument(Argument newArgument, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DockerfileGeneratorPackage.WORKDIR__ARGUMENT, oldArgument, newArgument);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newArgument != argument) {
			...
			if (argument != null)
				msgs = ((InternalEObject) argument).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DockerfileGeneratorPackage.WORKDIR__ARGUMENT, null, msgs);
			if (newArgument != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DockerfileGeneratorPackage.WORKDIR__ARGUMENT,
