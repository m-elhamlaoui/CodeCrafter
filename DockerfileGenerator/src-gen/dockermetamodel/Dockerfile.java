 ...
 * </ul>
 *
 * @see dockermetamodel.DockerfileGeneratorPackage#getDockerfile()
 * @model
 * @generated
 */
public interface Dockerfile extends EObject {
	 ...
	 * @see dockermetamodel.DockerfileGeneratorPackage#getDockerfile_Instruction()
	 ...
	 * @see #setName(String)
	 * @see dockermetamodel.DockerfileGeneratorPackage#getDockerfile_Name()
	 * @model
	 * @generated
	 */
	String getName();
	 ...
	 * @see dockermetamodel.DockerfileGeneratorPackage#getDockerfile_Version()
	 * @model
	 * @generated
	 */
	String getVersion();
